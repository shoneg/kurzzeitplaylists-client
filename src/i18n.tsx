...
const messages: Record<Language, Messages> = {
  en: {
    ...
    'aggregations.title': 'Playlist aggregations',
    'aggregations.subtitle': 'Build one target playlist from multiple source playlists without duplicates.',
    'aggregations.loading': 'Loading aggregation rules...',
    'aggregations.login.title': 'Log in to manage aggregations',
    'aggregations.login.subtitle': 'Connect your Spotify account to configure playlist unions.',
    'aggregations.login.cta': 'Log in with Spotify',
    'aggregations.rules.title': 'Configured rules',
    'aggregations.rules.new': 'New rule',
    'aggregations.rules.empty': 'No aggregation rules yet.',
    'aggregations.targetType.label': 'Target playlist',
    'aggregations.targetType.existing': 'Use existing playlist',
    'aggregations.targetType.new': 'Create new playlist',
    'aggregations.target.existing': 'Existing target playlist',
    'aggregations.target.new': 'Name for new target playlist',
    'aggregations.target.newPlaceholder': 'e.g. Weekly Combined Mix',
    'aggregations.target.select': 'Select a target playlist',
    'aggregations.mode.label': 'Aggregation mode',
    'aggregations.mode.exact_union': 'Exact union',
    'aggregations.mode.add_missing': 'Only add missing songs',
    'aggregations.sources.label': 'Source playlists (top to bottom)',
    'aggregations.sources.select': 'Select source playlist',
    'aggregations.sources.add': 'Add source',
    'aggregations.sources.manualPlaceholder': 'Paste Spotify playlist URL, URI, or ID',
    'aggregations.sources.manualAdd': 'Add by link/ID',
    'aggregations.sources.manualInvalid': 'Please enter a valid Spotify playlist URL, URI, or ID.',
    'aggregations.sources.empty': 'No source playlists selected yet.',
    'aggregations.sources.up': 'Up',
    'aggregations.sources.down': 'Down',
    'aggregations.sources.remove': 'Remove',
    'aggregations.save.cta': 'Save rule',
    'aggregations.save.saving': 'Saving...',
    'aggregations.save.success': 'Saved. Target "{target}": +{added}, -{removed}.',
    'aggregations.run.cta': 'Run now',
    'aggregations.run.running': 'Running...',
    'aggregations.run.success': 'Run complete for "{target}": +{added}, -{removed}.',
    'aggregations.delete.cta': 'Delete rule',
    'aggregations.delete.deleting': 'Deleting...',
    'aggregations.delete.success': 'Aggregation rule deleted.',
    'aggregations.validation.targetRequired': 'Please select a target playlist.',
    'aggregations.validation.newNameRequired': 'Please enter a name for the new target playlist.',
    'aggregations.validation.sourcesRequired': 'Please select at least one source playlist.',
    'aggregations.validation.targetAsSource': 'Target playlist cannot be used as source playlist.',
